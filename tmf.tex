...
\graphicspath{{figures/}{F:/Cloud/GitHub/tmf/figs/}{F:/Cloud/GitHub/doctor/figs/}{F:/Cloud/GitHub/doctor/figs/python/}{F:/Cloud/GitHub/doctor/figs/ppt/}{F:/Cloud/GitHub/doctor/figs/svg/}{F:/Cloud/GitHub/doctor/figs/sem/}}
...
Specimens are illustrated in Fig. \ref{Fig:Specimen}, with the surface roughness  $R_a=0.1\rm{\mu m}$. The dimensions of specimens are in accordance with the standards ASTM E606 \cite{astm2012606} and E2207 \cite{standard2007e2207}, respectively. Specimens are manufactured by a CNC machining center and the surfaces are polished after turning. The solid specimens are used for uniaxial tests, whereas the multi-axial fatigue tests are performed in the tubular specimens. The strain gauge lengths are 12 mm and 25 mm for solid specimen and tubular specimens, respectively. The uniform temperature in the gage length of the specimens is generated by induction heating. Different multi-axial testing techniques are discussed in \cite{socie2000multiaxial}.
...
\caption{Varying temperatures in a tubular specimen with 25 mm of the gauge length, heated by an optimized induction coil. (a) Temperature variations of three thermal elements during a loading cycle. (b) Temperature deviations in the axial direction. \marked{The legend in (a) has to to be changed. Only the middle element is for monitoring. Change them to: Upper element; Monitoring; Lower element. (b) The legend changes to: Upper element deviation, Lower element deviation. }}
